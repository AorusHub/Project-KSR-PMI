    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-gray-600 text-sm mt-1">Kelola seluruh stok darah KSR PMI UNHAS</p>
            </div>
            ...
            <div class="w-72">
                ...
                <form method="GET" action="{{ route('stok-darah.index') }}">
                    <select name="jenis_darah" 
                            ...
                            class="w-full px-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <p class="text-3xl font-bold text-red-600 leading-none mb-1">
