...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4">
        ...
        {{-- Back Button --}}
        <div class="mb-4">
            <a href="{{ route('kegiatan.index') }}" class="inline-flex items-center text-gray-700 hover:text-gray-900 transition-colors text-sm">
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="relative h-52 bg-gradient-to-r from-red-700 to-red-800">
                <img src="{{ asset('images/donor-illustration.png') }}" 
                     alt="Donor Darah Illustration" 
                     class="w-full h-full object-cover">

                <span class="absolute top-3 right-3 px-3 py-1 text-xs font-bold rounded-full shadow-md
            ...
            <div class="p-8">
                ...
                {{-- Title --}}
                <h1 class="text-xl font-bold text-gray-900 mb-6">{{ $kegiatan->nama_kegiatan }}</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                    ...
                    <div class="space-y-5">
                        ...
                        {{-- Tentang Kegiatan --}}
                        <div>
                            <h3 class="text-sm font-bold text-gray-900 mb-2">Tentang Kegiatan Ini</h3>
                            <div class="text-xs text-gray-700 leading-relaxed">
                                @if($kegiatan->deskripsi)
                                    {!! nl2br(e($kegiatan->deskripsi)) !!}
                                @else
                                    <p>Kegiatan donor darah rutin di kampus Universitas Hasanuddin. Mari berbagi kehidupan bersama KSR PMI UNHAS!</p>
                                @endif
                            </div>
                        </div>
                        ...
                        {{-- Persyaratan Donor --}}
                        <div>
                            <h3 class="text-sm font-bold text-gray-900 mb-2">Persyaratan Donor</h3>
                            <ul class="text-xs text-gray-700 leading-relaxed space-y-0.5">
                                <li>Berusia 17-60 tahun</li>
                                <li>Berat badan minimal 45 kg</li>
                                <li>Dalam kondisi sehat</li>
                                <li>Tidak sedang hamil atau menyusui</li>
                                <li>Tidak sedang demam</li>
                        ...
                        {{-- Yang Perlu Dibawa --}}
                        <div>
                            <h3 class="text-sm font-bold text-gray-900 mb-2">Yang Perlu Dibawa</h3>
                            <ul class="text-xs text-gray-700 leading-relaxed space-y-0.5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <div class="w-8 h-8 bg-red-50 rounded-lg flex items-center justify-center flex-shrink-0 mr-3">
                        ...
                        <button onclick="handleDaftar({{ $kegiatan->kegiatan_id }}, {{ $sudahDaftar ? 'true' : 'false' }})" 
                                id="btnDaftar"
                                class="w-full mt-2 py-3 rounded-lg font-bold text-white text-sm transition-all duration-200
                                {{ $sudahDaftar ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700 shadow-md' }}"
                ...
                {{-- Map Section --}}
                <div class="mt-6">
                    <div class="flex items-center justify-center h-44 bg-gray-100 rounded-lg">
...
<div id="modalSuccess" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 relative">
        ...
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-8">Anda telah terdaftar untuk kegiatan donor darah ini. Terima kasih!</p>
